...
set pm3d
#set zbrange [ -10: 10] 
set cbrange [ -0.482E+11: 0.482E+11 ] 
set view map
set size ratio -1
set border lw 3
set xlabel 'k (1/{\305})'
...
splot 'Berrycurvature.dat' u 1:2:4 w pm3d
unset ylabel
unset ytics
set title 'Berry Curvature {/Symbol W}_y ({\305}^2)'
splot 'Berrycurvature.dat' u 1:2:5 w pm3d
set title 'Berry Curvature {/Symbol W}_z ({\305}^2)'
set colorbox
splot 'Berrycurvature.dat' u 1:2:6 w pm3d
unset multiplot
unset label 1
...
set multiplot layout 1,3 rowsfirst \
              margins screen MP_LEFT, MP_RIGHT, MP_BOTTOM, MP_TOP spacing screen MP_GAP
set cbrange [ -0.907E+11: 0.907E+11 ] 
set title 'Berry Curvature {/Symbol W}_x ({\305}^2)'
splot 'Berrycurvature.dat' u 1:2:10 w pm3d
unset ylabel
unset ytics
set title 'Berry Curvature {/Symbol W}_y ({\305}^2)'
splot 'Berrycurvature.dat' u 1:2:11 w pm3d
set title 'Berry Curvature {/Symbol W}_z ({\305}^2)'
set colorbox
splot 'Berrycurvature.dat' u 1:2:12 w pm3d
