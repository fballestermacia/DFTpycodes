...
qpoints, bands = utilsQE.readPhononbandFreq(r"QE_projects\AgP2\phonons\444\AgP2.newHSP.freq.gp")

qlabels, positions = utilsQE.readHighSymPointsPhonon(r"QE_projects\AgP2\phonons\444\matdyn.newHSP.in")
